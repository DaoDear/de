...
#### 19) เปิด consumer console เพื่อดูการเปลี่ยนแปลง
```
[open new terminal: TERMINAL#2]
...
#### 20) เริ่มต้นไฟล์ lab3.3.source.txt และ lab3.3.sink.txt จะไม่มีข้อมูลข้างใน
```
...
#### 21) ทำการเพิ่มข้อมูลเข้าไปในไฟล์ lab3.3.source.txt เป็นจำนวน 2 บรรทัด
```
[TERMINAL#3]
...
#### 22) จะปรากฎผลลัพธ์ใน consumer console
```
[switch to TERMINAL#2]
...
23) เมื่อดูข้อมูลในไฟล์ lab3.3.source.txt และ lab3.3.sink.txt ก็จะตรงกัน
```
...
24) ปิด Terminal ทั้งหมดเพื่อเตรียมพร้อมสำหรับ Lab 3 (Part2)
